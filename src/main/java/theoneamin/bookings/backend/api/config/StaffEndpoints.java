...
public class StaffEndpoints {
    public static final String USERS_STAFF = "/api/users/staff";
    public static final String USERS_STAFF_ALL = "/api/users/staff/all";
    ...
    public static final String PAGE_SIZE = "/api/users/staff/page-size/{pageSize}";
}
